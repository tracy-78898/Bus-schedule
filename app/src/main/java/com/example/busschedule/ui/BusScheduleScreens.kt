...
//Main composable function that sets up navigation
@Composable
fun BusScheduleApp(
...
@Composable
//displays the full list of bus schedules
...
@Composable
//displays schedule for specific stop ; stop name is passed as argument thru nav
...
@Composable
//displays list of schedules, may display or show clickable
...
@Composable
//displays details ogf schedules
